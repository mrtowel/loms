...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CaseFile.size'
        db.add_column(u'cases_casefile', 'size',
                      self.gf('django.db.models.fields.CharField')(default=' ', max_length=100),
                      keep_default=False)

        # Adding field 'CaseFile.content_type'
        db.add_column(u'cases_casefile', 'content_type',
                      self.gf('django.db.models.fields.CharField')(default=' ', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CaseFile.size'
        db.delete_column(u'cases_casefile', 'size')

        # Deleting field 'CaseFile.content_type'
        db.delete_column(u'cases_casefile', 'content_type')
